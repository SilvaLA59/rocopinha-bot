...
module.exports = async bp => {
  ...
  const webchat = {
    botName: 'Consultor Saude',
    botAvatarUrl: 'http://rocopinha.com.br/robo.png', // You can provide a URL here
    botConvoTitle: 'Assistente online',
    botConvoDescription: "Hello, how can I help you?",
    backgroundColor: '#ffffff',
    textColorOnBackground: '#666666',
    foregroundColor: '#000000',
    textColorOnForeground: '#ffffff',
    welcomeMsgEnable: false,
